...
public interface PlayerActions {
	...
	abstract ControlCode tempBanPlayer(String player, UUID sourceUuid, String sourceName, ZonedDateTime endTime, String message);
	abstract ControlCode tempBanIp(String ip, UUID sourceUuid, String sourceName, ZonedDateTime endTime, String message);
